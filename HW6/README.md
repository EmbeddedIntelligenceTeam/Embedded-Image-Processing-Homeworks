...
2. [Implemented CNN Models](#implemented-cnn-models)
...
| Model | Parameters | Validation Accuracy | TFLite Size |
|-------|------------|---------------------|-------------|
...
│   ├── hw6_interactive.py            # Interactive PC-STM32 test script
...
│   ├── ResNet8.tflite                # 96.3 KB
│   ├── EfficientNetMini.tflite       # 108.5 KB
│   └── ... (11 models total)
│
├── STM32/                             # STM32CubeIDE project files
...
cd EE4065_HW6_Project

# Install dependencies
pip install -r Python/requirements.txt

# Run interactive testing
python Python/hw6_interactive.py
```

### STM32 Setup

1. **Create STM32CubeIDE project** for Nucleo-F446RE
2. **Copy TensorFlow Lite Micro** source files
